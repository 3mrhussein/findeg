...
import { CurrencyCode, TranslationMap } from '../../types';
...
export const variantPriceLists = catalogSchema.table(
  'variant_price_lists',
  {
    ...
    customerGroup: customerGroupEnum('customer_group').notNull(),
