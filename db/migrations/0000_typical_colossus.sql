...
CREATE TABLE "identity"."users" (
	...
	"portal_role" varchar(20) DEFAULT 'customer' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "catalog"."variant_price_lists" (
	"id" serial PRIMARY KEY NOT NULL,
	"variant_id" integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "catalog"."variant_sellable_uoms" (
	"id" serial PRIMARY KEY NOT NULL,
	"variant_id" integer NOT NULL,
	"uom_code" text NOT NULL,
	"factor_to_base" numeric(12, 4) NOT NULL,
	"localized_label" jsonb DEFAULT '{}'::jsonb,
	"barcode" text,
...
CREATE INDEX "idx_variant_attr_num" ON "catalog"."variant_attributes" USING btree ("attribute_id","value_num");--> statement-breakpoint
CREATE INDEX "idx_variant_images_variant" ON "catalog"."variant_images" USING btree ("variant_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_variant_price_lists_variant_group_uom" ON "catalog"."variant_price_lists" USING btree ("variant_id","customer_group","uom_code","min_qty");--> statement-breakpoint
CREATE INDEX "idx_variant_price_lists_variant" ON "catalog"."variant_price_lists" USING btree ("variant_id");--> statement-breakpoint
CREATE INDEX "idx_variant_price_lists_customer_group" ON "catalog"."variant_price_lists" USING btree ("customer_group");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_variant_sellable_uoms_variant_uom" ON "catalog"."variant_sellable_uoms" USING btree ("variant_id","uom_code");--> statement-breakpoint
CREATE INDEX "idx_variant_sellable_uoms_variant" ON "catalog"."variant_sellable_uoms" USING btree ("variant_id");--> statement-breakpoint
