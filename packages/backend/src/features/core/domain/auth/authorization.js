...
export function isSystemAdmin(session) {
    var _a;
    return ((_a = session.activeRoleIds) === null || _a === void 0 ? void 0 : _a.includes("system_admin")) === true;
}
/**
...
export function isAdminSession(session) {
    var _a, _b;
    if (session.portalRole === "staff" || session.portalRole === "school_staff")
        return true;
    if ((_a = session.activeRoleIds) === null || _a === void 0 ? void 0 : _a.some((roleId) => ADMIN_ROLE_IDS.has(roleId))) {
        return true;
    }
    if ((_b = session.permissionCodes) === null || _b === void 0 ? void 0 : _b.includes(PERMISSION_CODES.ADMIN_PORTAL)) {
        return true;
    }
    return false;
}
 ...
 */
export function hasPermission(session, requiredPermission) {
 ...
 */
export function hasAnyPermission(session, requiredPermissions) {
