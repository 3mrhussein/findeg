...
export declare const authAccounts: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        provider: import("drizzle-orm/pg-core").PgColumn<{
            ...
            data: "credentials" | "google" | "facebook" | "apple" | "other";
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
            ...
            length: 40;
            $type: "credentials" | "google" | "facebook" | "apple" | "other";
        }>;
 ...
 */
export declare const passwordCredentials: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        hashStrategy: import("drizzle-orm/pg-core").PgColumn<{
            name: "hash_strategy";
            tableName: "password_credentials";
            dataType: "string";
            columnType: "PgVarchar";
...
export declare const paymentMethods: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        provider: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgVarchar";
            data: "other" | "paymob" | "stripe" | "manual";
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
            ...
            length: 40;
            $type: "other" | "paymob" | "stripe" | "manual";
        }>;
        tokenReference: import("drizzle-orm/pg-core").PgColumn<{
 ...
 */
export declare const guestPrincipals: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "guest_principals";
    schema: "identity";
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "guest_principals";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
        ...
        guestKey: import("drizzle-orm/pg-core").PgColumn<{
            name: "guest_key";
            tableName: "guest_principals";
            dataType: "string";
            columnType: "PgVarchar";
...
export declare const authAccountsRelations: import("drizzle-orm").Relations<"auth_accounts", {
    user: import("drizzle-orm").One<"users", true>;
}>;
export declare const passwordCredentialsRelations: import("drizzle-orm").Relations<"password_credentials", {
    user: import("drizzle-orm").One<"users", true>;
}>;
