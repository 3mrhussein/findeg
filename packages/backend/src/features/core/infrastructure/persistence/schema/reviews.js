 ...
 */
import { serial, text, integer, decimal, timestamp, boolean, uniqueIndex, } from "drizzle-orm/pg-core";
 ...
 */
export const reviewHelpfulVotes = catalogSchema.table("review_helpful_votes", {
    id: serial("id").primaryKey(),
    ...
    uqReviewVoter: uniqueIndex("uq_review_helpful_votes_review_voter").on(table.reviewId, table.voterKey),
}));
/**
 * Relations
 */
