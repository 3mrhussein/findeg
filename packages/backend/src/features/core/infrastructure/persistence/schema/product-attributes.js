 ...
 */
import { serial, text, integer, boolean, timestamp, jsonb, decimal, primaryKey, index, } from "drizzle-orm/pg-core";
 ...
 */
export const productAttributes = catalogSchema.table("product_attributes", {
