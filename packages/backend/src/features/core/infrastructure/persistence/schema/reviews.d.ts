 ...
 */
export declare const reviewHelpfulVotes: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        voterKey: import("drizzle-orm/pg-core").PgColumn<{
            name: "voter_key";
            tableName: "review_helpful_votes";
            dataType: "string";
            columnType: "PgText";
...
export declare const reviewHelpfulVotesRelations: import("drizzle-orm").Relations<"review_helpful_votes", {
