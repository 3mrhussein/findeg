...
import type { AuthProvider, PaymentProvider, PermissionCode, RoleId, RoleScope } from "@/features/core/domain/value-objects";
 ...
 */
export declare const getUserFullName: (user: Pick<User, "firstName" | "lastName">) => string;
