...
// FIX: Import hooks from '../hooks' instead of '../contexts'
...
const CheckoutPage: React.FC<PageProps> = ({ navigateTo }) => {
    ...
    if (cartItems.length === 0) {
        return (
            <Container className="py-20 text-center">
                ...
                <Button onClick={() => navigateTo('shop')} className="mt-4">{t('hero_button_shop')}</Button>
            </Container>
        );
    }
