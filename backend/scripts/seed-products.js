...
import { products, productVariants, variantImages, inventoryBalances, } from "@features/core/infrastructure/persistence/schema";
async function seedProducts() {
    ...
    for (const item of productData) {
        ...
        const [spu] = await db
            ...
            categoryId: item.cat,
            brandId: item.brand,
            isActive: (_a = item.active) !== null && _a !== void 0 ? _a : true,
        })
        ...
        const [variant] = await db
            ...
            isActive: (_b = item.active) !== null && _b !== void 0 ? _b : true,
        })
