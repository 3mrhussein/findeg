...
import type { ShippingAddress } from "@findeg/backend/features/order/domain/value-objects/ShippingAddress";
import type { VariantSnapshot } from "@findeg/backend/features/order/domain/value-objects/VariantSnapshot";
import type {
  CurrencyCode,
  OrderStatus,
  PaymentMethod,
...
export type { ShippingAddress as ShippingAddressSnapshot } from "@findeg/backend/features/order/domain/value-objects/ShippingAddress";
