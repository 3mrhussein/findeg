...
import { VariantEntity, type Variant } from "@findeg/backend/features/catalog/domain/entities/Variant";
import type { SearchParams } from "@findeg/backend/features/catalog/application/interfaces/ISearchService";
