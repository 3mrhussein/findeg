...
describe("Backend Package Exports", () => {
  it("should load repository contract interfaces module", async () => {
    ...
    const module = await import("@backend/features/core/infrastructure/persistence/contracts");
  ...
  it("should export JWT service", async () => {
    const { JWTService, createJWTService } =
      await import("@backend/features/identity/application/services/JWTService");
  ...
  it("should create JWT service instance", async () => {
    const { JWTService } = await import("@backend/features/identity/application/services/JWTService");
