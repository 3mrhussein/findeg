...
describe("Backend Package Exports", () => {
  it("should load repository contract interfaces module", async () => {
    ...
    const module = await import("@findeg/backend/features/core/infrastructure/persistence/contracts");
  ...
  it("should export JWT service", async () => {
    const { JWTService, createJWTService } =
      await import("@findeg/backend/features/identity/application/services/JWTService");
  ...
  it("should create JWT service instance", async () => {
    const { JWTService } = await import("@findeg/backend/features/identity/application/services/JWTService");
    ...
    const service = new JWTService(
      ...
      "test-refresh-secret-32-chars-min!",
    );
