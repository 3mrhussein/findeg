...
import { CartTrigger } from "@/features/order/presentation/components/CartTrigger";
import { CartDrawer } from "@/features/order/presentation/components/CartDrawer";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {isAuthenticated ? (
              ...
              <DropdownMenuItem asChild>
                <Link href="/registration">{t("Pages.Auth.SigninLink")}</Link>
              </DropdownMenuItem>
            )}
          </DropdownMenuContent>
        </DropdownMenu>
