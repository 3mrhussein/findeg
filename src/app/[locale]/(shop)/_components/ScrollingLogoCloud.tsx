...
export const ScrollingLogoCloud: React.FC<ScrollingLogoCloudProps> = ({
  ...
  return (
    <div className="group relative overflow-hidden whitespace-nowrap [mask-image:_linear-gradient(to_right,_transparent_0,_black_128px,_black_calc(100%-128px),_transparent_100%)]">
