    ...
    <section className="w-full bg-slate-50 dark:bg-slate-900/50 py-16">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="group flex flex-col items-center text-center p-6 rounded-2xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="group flex flex-col items-center text-center p-6 rounded-2xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
            ...
            <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Fast Checkout</h3>
            <p className="text-slate-600 dark:text-slate-400">
