    ...
    <Card className="col-span-1 border-slate-200 shadow-sm overflow-hidden">
      <CardHeader className="border-b border-slate-100 bg-slate-50/50 pb-5">
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-lg font-semibold text-slate-900">{t("Title")}</CardTitle>
...
function CompletionRow({
  ...
  return (
    <Link href={href} className="group block hover:bg-slate-50/80 transition-colors p-4 sm:p-5">
