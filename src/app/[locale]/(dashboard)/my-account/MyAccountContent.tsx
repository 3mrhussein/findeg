  ...
  if (!isLoggedIn || !currentUser) {
    return (
      <Container className="py-20 text-center">
        ...
        <Button onClick={() => router.push("/registration")} className="mt-4">
          {t("Pages.MyAccount.SignIn")}
        </Button>
      </Container>
    );
  }
      ...
      <Container className="py-12 lg:py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-2">
            {t("Pages.MyAccount.Welcome", { name: currentUser.name })}
          </p>
        </div>
          ...
          <TabsContent value="profile">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <strong className="font-semibold">{t("Pages.MyAccount.NameLabel")}:</strong>{" "}
                  {currentUser.name}
                </div>
                <div>
                  <strong className="font-semibold">{t("Pages.MyAccount.EmailLabel")}:</strong>{" "}
                  {currentUser.email}
                </div>
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {t("Pages.MyAccount.OrderDate")}: {order.date}
                            </div>
                          </div>
