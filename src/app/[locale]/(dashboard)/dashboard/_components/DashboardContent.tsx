...
export const DashboardContent: React.FC<DashboardContentProps> = ({
  ...
  const navItems = [
    {
      id: "overview",
      label: t("Pages.Dashboard.Overview"),
    ...
    },
    {
      ...
      icon: <Icon name="shoppingCart" className="w-5 h-5" />,
    },
    {
      id: "customers",
  ...
  return (
    <div className="flex min-h-screen bg-muted">
      ...
      >
        ...
        <div className="p-2 border-t border-border">
          <Tooltip
            tip={
              isCollapsed
                ? t("Pages.Dashboard.ExpandSidebar")
                : t("Pages.Dashboard.CollapseSidebar")
            }
      ...
      <div
        className={cn(
          "flex flex-col grow transition-all duration-300 ease-in-out",
          isCollapsed ? "ltr:pl-20 rtl:pr-20" : "ltr:pl-64 rtl:pr-64",
        )}
      >
        ...
        <main className="grow p-8 overflow-auto">{renderContent()}</main>
      </div>
    </div>
  );
};
