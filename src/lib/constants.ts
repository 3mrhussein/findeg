...
export const products: Product[] = [
  {
    ...
    description:
      "A set of 12 high-quality gel pens in vibrant colors. Perfect for journaling and art projects.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Durable and comfortable backpack with multiple compartments and reflective safety strips.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Professional grade 24-color watercolor set with two brushes and a mixing palette.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "1000-piece educational puzzle featuring detailed illustrations of our solar system.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "BPA-free insulated lunch box that keeps food fresh for hours. Easy to clean and carry.",
    longDescription:
  ...
  },
  {
    ...
    name: "Sketchbook A4",
    description:
      "Hardcover sketchbook with 100 sheets of 150gsm acid-free paper. Ideal for all dry media.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Ultra-soft and cuddly 12-inch teddy bear. Made from premium hypoallergenic materials.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Set of 12 professional drawing pencils ranging from 8B to 4H. Includes a metal tin.",
    longDescription:
  ...
  },
  {
    ...
    name: "Kids Play Tent",
    description:
      "Easy-to-assemble indoor/outdoor play tent. Stimulates imaginative play and provides a cozy space.",
    longDescription:
...
export const orders: Order[] = [
  {
    ...
    items: [
      ...
      { productId: 3, productName: "Ergonomic School Backpack", quantity: 1, price: 45.0 },
    ],
  },
  {
    id: "ORD-002",
    ...
    total: 45.0,
    status: "shipped",
    items: [{ productId: 3, productName: "Ergonomic School Backpack", quantity: 1, price: 45.0 }],
  },
  {
    id: "ORD-003",
    ...
    items: [
      ...
      { productId: 5, productName: "Solar System Puzzle", quantity: 2, price: 24.5 },
    ],
  },
  {
    id: "ORD-004",
  ...
  },
  {
    ...
    total: 34.5,
    status: "cancelled",
    items: [{ productId: 2, productName: "Wooden Building Blocks", quantity: 1, price: 34.5 }],
  },
];
...
export const reviews: Review[] = [
  {
    ...
    date: "2024-07-15",
    comment:
      "These pens are amazing! The colors are so vibrant and they write so smoothly. I use them for my bullet journal every day.",
  },
  {
    id: 2,
    productId: 1,
    ...
    date: "2024-07-20",
    comment:
      "Great set of pens. A couple of them were a bit scratchy at first, but they seem to have broken in now. Good value for the price.",
  },
  {
    id: 3,
    productId: 2,
    ...
    date: "2024-07-22",
    comment:
      "My son loves these blocks! They are very well made and the colors are beautiful. Great for building all sorts of things.",
  },
  {
    id: 4,
    productId: 3,
    ...
    date: "2024-07-25",
    comment:
      "This backpack is very sturdy and has lots of pockets. My daughter says it's very comfortable to wear, even when it's full of books.",
  },
  {
    id: 5,
    productId: 3,
    ...
    date: "2024-07-28",
    comment:
      "Good quality backpack. The zippers seem a bit stiff, but hopefully they will loosen up with use. Overall, I'm happy with the purchase.",
  },
  {
    id: 6,
    productId: 1,
    ...
    date: "2024-08-01",
    comment:
      "Best gel pens I've ever used. No smudging at all, which is great because I'm left-handed!",
  },
  {
    id: 7,
    productId: 2,
    ...
    date: "2024-08-03",
    comment:
      "Nice set of blocks. I wish there were a few more of the larger pieces, but my kids still have fun with them.",
  },
  {
    id: 8,
    productId: 5,
    ...
    date: "2024-07-10",
    comment:
      "This puzzle is challenging but so rewarding! The image is beautiful and the pieces fit together perfectly. Highly recommend for any space lover.",
  },
  {
    id: 9,
    productId: 3,
    ...
    date: "2024-07-14",
    comment:
      "Good quality backpack. Wish it had a dedicated water bottle pocket on the side, but otherwise it's great.",
  },
  {
    id: 10,
    productId: 1,
    ...
    date: "2024-07-28",
    comment:
      "I buy this set every year. I just love how smooth they are. The new colors in this version are beautiful!",
  },
  {
    id: 11,
    productId: 2,
    ...
    date: "2024-07-29",
    comment:
      "Absolutely timeless. My kids love these blocks more than their tablets. The quality is fantastic and they feel very durable.",
  },
  {
    id: 12,
    productId: 4,
    ...
    date: "2024-07-28",
    comment:
      "For the price, this is a great set. The colors are bright and it comes with everything you need to start. Perfect for a beginner.",
  },
  {
    id: 13,
    productId: 6,
    ...
    date: "2024-07-27",
    comment:
      "Keeps food cold all day. The material is easy to clean and it has held up really well after months of daily use. Great purchase.",
  },
  {
    id: 14,
    productId: 9,
    ...
    date: "2024-07-26",
    comment:
      "The paper quality is excellent for pencil and charcoal. Very little smudging and it has a nice tooth. Will buy again.",
  },
  {
    id: 15,
    productId: 10,
    ...
    date: "2024-07-25",
    comment:
      "Bought this for my grandson and he takes it everywhere. It is so incredibly soft and cuddly. A perfect classic teddy bear.",
  },
  {
    id: 16,
    productId: 11,
    ...
    date: "2024-07-24",
    comment:
      "A solid set of pencils for sketching. The range of hardness is great for shading. The tin case is a nice touch.",
  },
  {
    id: 17,
    productId: 12,
    ...
    date: "2024-07-23",
    comment:
      "Easy to set up and bigger than I expected! My son has turned it into his little clubhouse. It's been a huge hit.",
  },
  {
    id: 18,
    productId: 7,
    ...
    date: "2024-07-22",
    comment:
      "The leather cover is nice, but the paper is a bit thin for my liking. My fountain pen ink bleeds through slightly. Better for ballpoint pens.",
  },
  {
    id: 19,
    productId: 8,
    ...
    date: "2024-07-21",
    comment:
      "What a fantastic toy! My daughter and I had a blast building the different robots. It's educational and really fun to see it work with solar power.",
  },
  {
    id: 20,
    productId: 3,
    ...
    date: "2024-07-20",
    comment:
      "I was hesitant about the price, but this backpack is worth every penny. The support it offers for my daughter's back is noticeable. Very well made.",
  },
];
