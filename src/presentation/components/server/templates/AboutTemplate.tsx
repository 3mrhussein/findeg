...
import { BrandShowcase } from '@/presentation/components/client/molecules/BrandShowcase';
            ...
            <Container className="py-16 lg:py-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="rounded-lg overflow-hidden shadow-xl">
                        <img src="https://picsum.photos/seed/aboutus/800/600" alt="Team working" className="w-full h-full object-cover" />
                    </div>
                </div>
            </Container>
