...
import { ImageGallery } from '@/presentation/components/client/molecules/ImageGallery';
import { Grid } from '@/presentation/components/server/layout/Grid';
import { ProductCard } from '@/presentation/components/client/molecules/ProductCard';
import { AdBanner } from '@/presentation/components/server/molecules/AdBanner';
import { Price } from '@/presentation/components/server/atoms/Price';
import { DiscountBadge } from '@/presentation/components/client/atoms/DiscountBadge';
import { products, reviews as allReviews } from '@/constants';
import { Rating } from '@/presentation/components/server/atoms/Rating';
import { getTranslation } from '@/lib/i18n-server';
import { ProductActions } from '@/presentation/components/client/organisms/ProductActions';
import { ProductReviews } from '@/presentation/components/organisms/ProductReviews';
import { ProductStickyNav } from '@/presentation/components/client/organisms/ProductStickyNav';
...
const ProductDetailTemplate: React.FC<ProductDetailTemplateProps> = ({ productId, language = 'en' }) => {
